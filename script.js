...
function startScene3() {
    ...
    // Spawn realistic falling rain lines
    for (let i = 0; i < 40; i++) {
    ...
    function type1() {
        if (idx < msg1.length) {
            ...
            setTimeout(() => {
                // Kintsugi golden transition update
                ...
                setTimeout(() => {
                    ...
                    let msg2 = "I can't erase the cracks... but I'll spend every day filling them with love, care, and trust.";
                    let idx2 = 0;
                    function type2() {
                        if (idx2 < msg2.length) {
    ...
    buttons.forEach((btn, index) => {
        btn.addEventListener("click", () => {
            ...
            if (clicked === buttons.length) {
                setTimeout(() => {
                    gardenMsg.innerText = "Love grows where it's cared for. 🌸";
...
const wishes = ["Smile, Thango... 💖", "You're my favorite person. ✨", "I still fall in love with you every day. 🌅"];
...
document.getElementById("walk-forward-btn").addEventListener("click", () => {
    ...
    document.getElementById("scene6-text").innerText = "🌅 Sunrise breaks. The stars fade away. A beautiful new day begins for us.";
...
document.getElementById("envelope").addEventListener("click", () => {
    ...
    const fullLetter = "Dear Ammu,\n\nYou are my home, my comfort, and my entire world. Every single heartbeat of mine belongs completely to you. Thank you for being you.\n\nForever Yours,\nShameer";
    let i = 0;
...
document.getElementById("wish-btn").addEventListener("click", () => {
    ...
    // Shoot star element across sky layout
